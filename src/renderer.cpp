...
void Renderer::UpdateWindowTitle(Snake const &snake, Snake const &snake2, int fps) {
    std::string title{"Scores: Snake 1 (" + std::to_string(snake.GetScore()) + "), Snake 2 ("
        + std::to_string(snake2.GetScore()) + ") / FPS: " + std::to_string(fps)};
